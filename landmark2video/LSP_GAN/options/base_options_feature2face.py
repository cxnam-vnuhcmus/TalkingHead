...
class BaseOptions():
    ...
    def initialize(self):  
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/root/LiveSpeechPortraits/LiveSpeechPortraits/checkpoints/', help='models are saved here')
        ...
        self.parser.add_argument('--dataroot', type=str, default='/root/LiveSpeechPortraits/LiveSpeechPortraits/data/') 
